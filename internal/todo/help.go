...
func HelpBlock(splitDates bool) string {
	...
	b.WriteString("#   +2h, -30m, +1d2h30m        Shift from the original time\n")
	b.WriteString("#   PREV                       Same as previous commit's original time\n")
	b.WriteString("#   PREV +45m                  Previous commit's original time + offset\n")
